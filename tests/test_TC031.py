...
def test_TC031_getdieid5(api_client, per_test_logger):
    """
    Test Case: API_TC_31  get die ID =5 value with Accept_Header as application/vnd.yahtzee.word+json
    """

    logger = per_test_logger
    Accept_Header = "application/vnd.yahtzee.word+json"
