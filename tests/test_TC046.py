...
def test_TC044_setdievalue_invaliduser(api_client, per_test_logger):
    """
    API_TC46 Set Die value with wrong username and password
    :param api_client:
    ...
    response = put_dievalue_wronguser_password(api_client, 1, 1)
